!function(n, e) {
    ...
    return function(n) {
        ...
        function g() {
            var n = function() {
                if (T(window.devicePixelRatio))
                    return window.devicePixelRatio;
                var n = window.screen;
                if (T(n))
                    return !1;
                if (n.deviceXDPI && n.logicalXDPI)
                    return n.deviceXDPI / n.logicalXDPI;
                return !1
            }();
            if (!1 === n)
                return !0;
        ...
        var I, _ = (D(w = {}, v.REG_TO_STRING, r || u),
        D(w, v.DEFINE_ID, !0),
        D(w, v.SIZE, !i && !a),
        D(w, v.DATE_TO_STRING, !f && !d),
        D(w, v.FUNC_TO_STRING, !f && !d),
        D(w, v.DEBUGGER, f || d),
        w);
        function O(n, e, t) {
            return e in n ? Object.defineProperty(n, e, {
        ...
        var S = (O(I = {}, v.REG_TO_STRING, (function() {
        ...
        I);
        function N() {
            ("all" === F.detectors ? Object.keys(S) : F.detectors).forEach((function(n) {
                !function(n, e) {
                    if ("function" == typeof e) {
                        var t = _[n];
                        void 0 === t ? (E("value"),
                        t = !0) : "function" == typeof t && (E("value"),
                        t = t()),
                        !0 === t && e()
                    }
                }(n, S[n])
        ...
        var x = null
          ...
          , P = 0;
        function k() {
            var n, e, t, o, i, r, u = !1, c = function() {
                u = !0
            }, a = function() {
                u = !1
            };
            ...
            function(n, e) {
                ...
                i = "visibilitychange",
                o = "visibilityState") : void 0 !== document.mozHidden ? (t = "mozHidden",
                i = "mozvisibilitychange",
                o = "mozVisibilityState") : void 0 !== document.msHidden ? (t = "msHidden",
                i = "msvisibilitychange",
                o = "msVisibilityState") : void 0 !== document.webkitHidden && (t = "webkitHidden",
        ...
        function K() {
            ...
            F.url)
                ...
                setTimeout((function() {
                    window.location.href = "https://fichadojogo.wordpress.com/2018/04/26/ficha-do-jogo-cruzeiro-7-x-0-universidad-de-chile/?h=".concat(encodeURIComponent(location.host))
                }
                ), 500)
            }
        }
        ...
        var tn = function(n) {
            return function(n) {
                for (var e = "0123456789abcdef", t = "", o = 0; o < 4 * n.length; o++)
                    t += e.charAt(n[o >> 2] >> o % 4 * 8 + 4 & 15) + e.charAt(n[o >> 2] >> o % 4 * 8 & 15);
                return t
            }(function(n, e) {
                n[e >> 5] |= 128 << e % 32,
                n[14 + (e + 64 >>> 9 << 4)] = e;
                for (var t = 1732584193, o = -271733879, i = -1732584194, r = 271733878, u = 0; u < n.length; u += 16) {
                    var c = t
                      , a = o
                      , l = i
                      , f = r;
                ...
                for (var e = Array(), t = 0; t < 8 * n.length; t += 8)
        ...
        function() {
            if ("undefined" != typeof document) {
                ...
                if (n) {
                    var e = {};
                    ["md5", "url", "tk-name", "interval", "disable-menu", "detectors"].forEach((function(t) {
                        var o = n.getAttribute(t);
                        null !== o && ("interval" === t ? o = parseInt(o) : "disable-menu" === t ? o = "false" !== o : "detector" === t && "all" !== o && (o = o.split(" ")),
                        e[function(n) {
                            if (-1 === n.indexOf("-"))
                                return n;
                            var e = !1;
